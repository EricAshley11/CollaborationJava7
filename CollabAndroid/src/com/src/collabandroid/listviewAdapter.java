...
public class listviewAdapter extends BaseAdapter
{
 ...
 System.out.println();
                ...
                holder.txtFirst.setText(FIRST_COLUMN);//map.get(FIRST_COLUMN));
                holder.txtSecond.setText(SECOND_COLUMN);//map.get(SECOND_COLUMN));
                holder.txtThird.setText(THIRD_COLUMN);//map.get(THIRD_COLUMN));
                holder.txtFourth.setText(FOURTH_COLUMN);//map.get(FOURTH_COLUMN));
